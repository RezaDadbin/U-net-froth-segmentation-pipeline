...
class UNet(nn.Module):
    def __init__(self, in_channels=3, base=64, out_channels=1, bilinear=True):
        super().__init__()
...
def build_unet(in_channels=3, out_channels=1, base=64):
    return UNet(in_channels=in_channels, out_channels=out_channels, base=base)
